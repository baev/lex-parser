 ...
 *         Date: 02.04.13
 */
public class ParserAPlusAATest {
    private static final String FILE_PATH = "ru/ifmo/sta/baev/parser/ps-a-plus-aa-test-data.txt";
    ...
    @Test
    public void aPlusAAOperatorTest() {
        assertThat(tree.getToken(), is(Token.PLUS));
    }

    @Test
    public void aPlusAALeftOperandTest() {
        Tree left = tree.getLeft();
        assertThat(left.getToken(), is(Token.OPERAND));
        assertThat(left.getValue(), is(12));
    }

    @Test
    public void aPlusAARightOperandTest() {
        Tree right = tree.getRight();
        assertThat(right.getToken(), is(Token.OPERAND));
        assertThat(right.getValue(), is(2));
    }
}
